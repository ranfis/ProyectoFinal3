...
namespace TravelAgency.localhost {
    ...
    public partial class FlightService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/insertarClase", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void insertarClase(string id, string descripcion) {
            this.Invoke("insertarClase", new object[] {
                        id,
                        descripcion});
        }
        
        /// <remarks/>
        public void insertarClaseAsync(string id, string descripcion) {
            this.insertarClaseAsync(id, descripcion, null);
        }
        
        /// <remarks/>
        public void insertarClaseAsync(string id, string descripcion, object userState) {
            if ((this.insertarClaseOperationCompleted == null)) {
                this.insertarClaseOperationCompleted = new System.Threading.SendOrPostCallback(this.OninsertarClaseOperationCompleted);
            }
            this.InvokeAsync("insertarClase", new object[] {
                        id,
                        descripcion}, this.insertarClaseOperationCompleted, userState);
        }
        
        private void OninsertarClaseOperationCompleted(object arg) {
            if ((this.insertarClaseCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.insertarClaseCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17379")]
    public delegate void insertarClaseCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
}
