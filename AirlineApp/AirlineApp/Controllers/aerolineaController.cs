...
{ 
    public class aerolineaController : Controller
    {
        ...
        {
            return View(db.aerolinea.ToList());
        }
        ...
        {
            aerolinea aerolinea = db.aerolinea.Single(a => a.codigo == id);
        ...
        public ActionResult Create(aerolinea aerolinea)
        {
            ...
            {
                db.aerolinea.AddObject(aerolinea);
                db.SaveChanges();
        ...
        {            
            aerolinea aerolinea = db.aerolinea.Single(a => a.codigo == id);
            db.aerolinea.DeleteObject(aerolinea);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
